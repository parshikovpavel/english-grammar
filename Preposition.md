...
| **about**                                 | около, приблизительно (неточный момент или интервал   времени) |                                                              |
...
Ниже представлены пары предлогов, имеющие противоположные значения

 

| **TO**   | В, к   (движение к цели и достижение ее) | I go to the theater Я хожу   в театр. |
| -------- | ---------------------------------------- | ------------------------------------- |
| **FROM** | От,   из (отдаление от чего-либо)        | I fly from Russia Я лечу из России    |

 

| **INTO**   | В (движение внутрь замкнутого пространства)                  | Children run into   the house Дети бегут в дом              |
| ---------- | ------------------------------------------------------------ | ----------------------------------------------------------- |
| **OUT OF** | Из (движение наружу, из замкнутого   пространства). В русском языке движение передается приставкой вы-   (выбегают, выходят) | Children run out of   the house Дети выбегают из дома       |
| **along**  | Вдоль, по (в направлении длины чего-то)                      | He goes along   (=down) the street Он идет   вдоль по улице |
| **across** | Поперек, через (пересекание чего-то, от одной стороны к другой) | He was swimming   across the river Он плыл через реку       |
...
.
 ...
 Источник контента: https://easyspeak.ru/blog/vsyo-o-grammatike/upotreblenie-predlogov-v-anglijskom-yazyke
 от одной стороны
...
| ----------- | --------------------------- | ------------------------------------------------- |
|             |                             |                                                   |
| **around**  | вокруг (какого-то объекта)  | I walked around the house    Я обошел вокруг дома |
| **THROUGH** | через, сквозь (стену, окно) | I got through  the window    Я попал через окно   |
